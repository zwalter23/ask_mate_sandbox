...
5	2021-02-03 10:13:42	0	8	Answer own question		tester@tester.test
6	2021-02-03 10:15:03	0	8	Answer count attempt		tester@tester.test
7	2021-02-03 10:17:34	0	8	Answer  count		tester@tester.test
\.
...
1	8	\N	where does this go	2021-02-03 10:23:25	0	tester@tester.test
\.
...
3	2021-02-02 16:58:17	4	3	How can I prevent SQL injection in PHP?	If user input is inserted without modification into an SQL query, then the application becomes vulnerable to SQL injection, like in the following example:\r\n\r\n		user1@domain.org
5	2021-02-03 10:02:53	1	0	This will test the quesition count	BLABLABLABLABLABALBALBALBALBALABLABLABALABLABALBALABLA		tester@tester.test
6	2021-02-03 10:05:16	0	0	Second test of the question counter	rsedzfghkjljlhiguifzdtfjgkjhlkjoiéoitufz		tester@tester.test
7	2021-02-03 10:09:19	0	0	Third question count test	fghvbjnklnkgjfhdfxcgvmbkjhgkutfzhtfcgvhbjh,kn		tester@tester.test
4	2021-02-02 16:59:03	3	7	Add a column with a default value to an existing table in SQL Server	How can I add a column with a default value to an existing table in SQL Server 2000 / SQL Server 2005?		dummy@stg.com
8	2021-02-03 10:13:14	3	1	4th test	zfguhijkéiouizut		tester@tester.test
1	2021-02-02 16:54:24	5	3	How do I UPDATE from a SELECT in SQL Server?	In SQL Server, it is possible to insert rows into a table with an INSERT.. SELECT statement:\r\n\r\nINSERT INTO Table (col1, col2, col3)\r\nSELECT col1, col2, col3 \r\nFROM other_table \r\nWHERE sql = cool		valaki@valahol.hu
...
1	valaki@valahol.hu	$2b$12$DpwM0dQNYFSvwTHvTBLH2uFYalaorQpE1b7V.T/T2bHxS8B0n6M46	2021-02-02 16:53:16+01	1	0	0	12
2	dummy@stg.com	$2b$12$FXQTwGJShnztvaL5Rlo.ve6lrIdx3gNNsW.ZyENwiNyPsRZiXRnHS	2021-02-02 16:54:59+01	1	0	0	9
3	user1@domain.org	$2b$12$X2hx.4clyxkFbMjUbl0q..LZ8oZDws3WlQ348P2MMaCC.3trZhblW	2021-02-02 16:55:22+01	1	0	0	7
4	tester@tester.test	$2b$12$bJSifxsAvpkLHelfnJ1z4uN85uKDV89LPEhv/eGsT6cPUaXpLVmh.	2021-02-02 17:15:24+01	4	1	1	1
\.
